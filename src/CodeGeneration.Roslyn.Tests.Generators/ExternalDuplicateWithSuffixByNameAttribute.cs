...
namespace Cythral.CodeGeneration.Roslyn.Tests.Generators
{
    ...
    [CodeGenerationAttribute("Cythral.CodeGeneration.Roslyn.Tests.Generators.ExternalDuplicateWithSuffixGenerator, Cythral.CodeGeneration.Roslyn.Tests.Generators, Version=" + ThisAssembly.AssemblyVersion + ", Culture=neutral, PublicKeyToken=null")]
